...
<!--
//-------------------------------------------------------------------------
// weewx using the weewx-wd extension to generate WD-compatible input files
//--------------------------------------------------------------------------
-->

<?php if($SITE['WXsoftware'] == 'WE') { // use weewx names of images and noaa files
   $WVgraphDescs = array(
      'd' => 'Daily',
 	 'w' => 'Weekly',
 	 'm' => 'Monthly',
 ...
 //$WVgraphIdx = 'w';  // default is 7-day set
 $WVgraphIdx = 'd';  // default is one-day set
 $WVgraphName = $WVgraphDescs[$WVgraphIdx];
 $WVgraphSet =  $WVgraphPeriods[$WVgraphIdx];
 ...
 print "</p>\n";	
  ?>
     <h2><?php echo langtransstr('Temperature'); ?></h2>
 	<?php genImageLink($WVgraphs[$WVgraphSet."-temp"],'Outside Temperature'); ?>
 	<?php genImageLink($WVgraphs[$WVgraphSet."-intemp"],'Inside Temperature'); ?>
     <br />
     ...
     <?php genImageLink($WVgraphs[$WVgraphSet."-wdir"],'Wind Direction'); ?>
     <br />
     <h2><?php langtrans('Wind Chill'); ?></h2>
     <?php genImageLink($WVgraphs[$WVgraphSet."-hc"],'Wind Chill'); ?>
     <br />
     <h2><?php langtrans('ISS Signal Quality'); ?></h2>
     <?php genImageLink($WVgraphs[$WVgraphSet."-rx"],'Signal Quality'); ?>
     <br />
     <?php // figure out to display solar and/or UV based on site settings
 	if($SITE['SOLAR'] and $SITE['UV']) { // have both sensors ?>
     <h2><?php echo langtransstr('Solar Radiation') . ' / ' . langtransstr('UV Index'); ?></h2>
